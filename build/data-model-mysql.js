...
module.exports = function (fig) {
    ...
    var parse = function (data) { return data && (_.isArray(data) ? _.map(data, parse) : _.extend(data, {
    ...
    self.setConfirmedByUsername = function (fig) { return sql.update(table, {
        isConfirmed: fig.isConfirmed
    }, {
        username: fig.username
    }); };
    self.setPasswordByUsername = function (fig) { return sql.update(table, {
