...
var self = this;
var createModel = function (override) {
    return require('./model')(_.extend({
        dataModel: dataModel,
        tokenSecret: 'secret',
...
describe('model', function () {
    beforeEach(function (done) {
        ...
        password
            ...
            return dataModel.insert({
                username: 'bob',
                email: 'bob@foo.com',
                password: hashedPassword,
            });
        })
            .then(function () { return dataModel.findByField('username', 'bob'); })
            .then(function (user) {
            self.user = user;
            return token.create({
                password: 'secret',
    ...
    describe('register', function () {
        it('should create unconfirmed user with hashed password', function (done) {
            model
                .register(self.data())
                .then(function () { return dataModel.findByField('username', self.data().username); })
                .then(function (user) {
    ...
    describe('sendConfirmation', function () {
        ...
        it('should validate that user is not already confirmed', function (done) {
            ...
            dataModel
                ...
                .then(function () { return self.model.sendConfirmation(self.user.username); })
                .catch(function (err) {
    ...
    describe('resetPasswordWithToken', function () {
        ...
        it('should reset password', function (done) {
            model
                ...
                .then(function () { return dataModel.findByField('username', self.user.username); })
                .then(function (userData) { return password.compare('new-pass', userData.password); })
                .then(function (isMatch) {
                chai.assert.ok(isMatch);
                done();
            })
